 ...
 * @brief   ERP Mini platform RQT feedback monitor GUI plugin
 * @author  Minkyu Kil
 * @date    2025-06-17
 * @version 1.0
 *
...
#include "erp_mini_rqt_plugin/feedback_monitor_plugin.hpp"
 ...
 */
erp_mini_rqt_plugin::FeedbackMonitorPlugin::FeedbackMonitorPlugin()
 ...
 * @details This method creates a ROS 2 node named "erp_mini_feedback_monitor",
 * sets up the UI components, subscribes to the "/erp_mini/feedback" topic,
 ...
 */
void erp_mini_rqt_plugin::FeedbackMonitorPlugin::initPlugin(qt_gui_cpp::PluginContext &context)
{
    // Initialize ROS2 node
    node_ = std::make_shared<rclcpp::Node>("erp_mini_feedback_monitor");
    ...
    // Subscribers
    feedback_sub_ = node_->create_subscription<erp_mini_msgs::msg::Feedback>(
        "/erp_mini/feedback",
 ...
 */
void erp_mini_rqt_plugin::FeedbackMonitorPlugin::shutdownPlugin()
{
 ...
 */
void erp_mini_rqt_plugin::FeedbackMonitorPlugin::saveSettings(
 ...
 * @param instance_settings Instance-specific settings.
 */
void erp_mini_rqt_plugin::FeedbackMonitorPlugin::restoreSettings(
...
/**
 * @brief Callback for the ERP Mini feedback topic.
 ...
 * @param msg Shared pointer to @c erp_mini_msgs::msg::Feedback .
 */
void erp_mini_rqt_plugin::FeedbackMonitorPlugin::feedback_callback(
    const erp_mini_msgs::msg::Feedback::SharedPtr msg
)
{
    // Control mode
    ...
    const QString gear_text =
        (gear == erp_mini_msgs::msg::Feedback::GEAR_FORWARD ) ? "Forward"  :
        (gear == erp_mini_msgs::msg::Feedback::GEAR_BACKWARD) ? "Backward" : "Neutral";
 ...
 */
bool erp_mini_rqt_plugin::FeedbackMonitorPlugin::select_target_node(std::string &node_name)
{
 ...
 */
void erp_mini_rqt_plugin::FeedbackMonitorPlugin::read_vehicle_parameters()
{
...
PLUGINLIB_EXPORT_CLASS(erp_mini_rqt_plugin::FeedbackMonitorPlugin, rqt_gui_cpp::Plugin)