 ...
 * @brief   ERP Mini platform RQT control panel GUI plugin
 * @author  Minkyu Kil
 * @date    2025-06-17
 * @version 1.0
 *
...
#include "erp_mini_rqt_plugin/control_panel_plugin.hpp"
 ...
 */
erp_mini_rqt_plugin::ControlPanelPlugin::ControlPanelPlugin()
 ...
 * @details This method creates a ROS 2 node named "erp_mini_control_panel",
 ...
 */
void erp_mini_rqt_plugin::ControlPanelPlugin::initPlugin(qt_gui_cpp::PluginContext &context)
{
    // Initialize ROS2 node
    node_ = std::make_shared<rclcpp::Node>("erp_mini_control_panel");
    ...
    // Publishers
    control_command_pub_ = node_->create_publisher<erp_mini_msgs::msg::ControlCommand>(
        "/erp_mini/control_command",
        rclcpp::QoS(rclcpp::KeepLast(1)).durability_volatile().reliable()
    );

    // Service clients
    mode_command_client_ = node_->create_client<erp_mini_msgs::srv::ModeCommand>(
 ...
 */
void erp_mini_rqt_plugin::ControlPanelPlugin::shutdownPlugin()
{
 ...
 */
void erp_mini_rqt_plugin::ControlPanelPlugin::saveSettings(
 ...
 */
void erp_mini_rqt_plugin::ControlPanelPlugin::restoreSettings(
...
/**
 * @brief Build and send an ERP Mini ModeCommand via ROS 2 service.
 * @details
 ...
 */
void erp_mini_rqt_plugin::ControlPanelPlugin::on_apply_mode_command()
{
    ...
    {
        QMessageBox::warning(widget_, "ERROR", "\"/erp_mini/mode_command\" service is not available.");
        return;
    }
    ...
    // Mode command
    auto mode_command_request = std::make_shared<erp_mini_msgs::srv::ModeCommand::Request>();
    ...
    mode_command_client_->async_send_request(mode_command_request,
        [this](rclcpp::Client<erp_mini_msgs::srv::ModeCommand>::SharedFuture future)
        {
 ...
 */
void erp_mini_rqt_plugin::ControlPanelPlugin::bind_slider_spin_box(
 ...
 */
void erp_mini_rqt_plugin::ControlPanelPlugin::control_command_timer_callback()
{
...
PLUGINLIB_EXPORT_CLASS(erp_mini_rqt_plugin::ControlPanelPlugin, rqt_gui_cpp::Plugin)