...
#ifndef ERP_MINI_RQT_PLUGIN__FEEDBACK_MONITOR_PLUGIN_HPP_
#define ERP_MINI_RQT_PLUGIN__FEEDBACK_MONITOR_PLUGIN_HPP_
...
namespace erp_mini_rqt_plugin
{
    ...
    private:
         ...
         */
        void feedback_callback(const erp_mini_msgs::msg::Feedback::SharedPtr msg);
    ...
    private:
        ...
        // Subscribers
        rclcpp::Subscription<erp_mini_msgs::msg::Feedback>::SharedPtr feedback_sub_;
...
#endif // ERP_MINI_RQT_PLUGIN__FEEDBACK_MONITOR_PLUGIN_HPP_