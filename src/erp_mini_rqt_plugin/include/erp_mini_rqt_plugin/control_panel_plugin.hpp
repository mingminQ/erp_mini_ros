...
#ifndef ERP_MINI_RQT_PLUGIN__CONTROL_PANEL_PLUGIN_HPP_
#define ERP_MINI_RQT_PLUGIN__CONTROL_PANEL_PLUGIN_HPP_
...
namespace erp_mini_rqt_plugin
{
    ...
    private:
        ...
        // Publishers
        rclcpp::Publisher<erp_mini_msgs::msg::ControlCommand>::SharedPtr control_command_pub_;

        // Service clients
        rclcpp::Client<erp_mini_msgs::srv::ModeCommand>::SharedPtr mode_command_client_;

        // Control command message
        erp_mini_msgs::msg::ControlCommand control_command_msg_;
...
#endif // ERP_MINI_RQT_PLUGIN__CONTROL_PANEL_PLUGIN_HPP_