...
#ifndef ERP_MINI_SERIAL__SERIAL_BRIDGE_HPP_
#define ERP_MINI_SERIAL__SERIAL_BRIDGE_HPP_

#include "erp_mini_serial/serial_port.hpp"
#include "erp_mini_serial/serial_packet.hpp"

#include "erp_mini_msgs/msg/control_command.hpp"
#include "erp_mini_msgs/srv/mode_command.hpp"
#include "erp_mini_msgs/msg/feedback.hpp"
...
{
    /**
     * @brief ROS2 node for serial communication on the ERP Mini platform.
    ...
    private:
         ...
         */
        void control_command_callback(const erp_mini_msgs::msg::ControlCommand::SharedPtr msg);
    ...
    private:
        ...
        // Publishers
        rclcpp::Publisher<erp_mini_msgs::msg::Feedback>::SharedPtr feedback_pub_;

        // Subscribers
        rclcpp::Subscription<erp_mini_msgs::msg::ControlCommand>::SharedPtr control_command_sub_;

        // Services
        rclcpp::Service<erp_mini_msgs::srv::ModeCommand>::SharedPtr mode_command_srv_;
...
#endif // ERP_MINI_SERIAL__SERIAL_BRIDGE_HPP_