...
#ifndef ERP_MINI_UTIL__LOG_HPP_
#define ERP_MINI_UTIL__LOG_HPP_

#include <string>

// Terminal log handler macro
#define ERP_MINI_DEBUG(msg, ...) erp_mini_util::print_log(__FILE__, __LINE__, erp_mini_util::LogLevel::DEBUG   , msg, ##__VA_ARGS__)
#define ERP_MINI_INFO(msg, ...)  erp_mini_util::print_log(__FILE__, __LINE__, erp_mini_util::LogLevel::INFO    , msg, ##__VA_ARGS__)
#define ERP_MINI_WARN(msg, ...)  erp_mini_util::print_log(__FILE__, __LINE__, erp_mini_util::LogLevel::WARNING , msg, ##__VA_ARGS__)
#define ERP_MINI_ERROR(msg, ...) erp_mini_util::print_log(__FILE__, __LINE__, erp_mini_util::LogLevel::ERROR   , msg, ##__VA_ARGS__)
