# erp_mini_msgs
ERP Mini ROS2 communication interfaces

<br/>

## ControlCommand.msg
ERP Mini control command includes speed, steering
...
## Feedback.msg
Feedback information from ERP Mini
| Field              | Type    | Unit                          | Description                                                                                                |
| ------------------ | ------- | ----------------------------- | ---------------------------------------------------------------------------------------------------------- |
...
## ModeCommand.srv
ERP Mini mode command includes control mode, E-Stop, gear
...
| **gear**           | uint8 | **Drive / Neutral / Reverse** | This field sets the vehicle's gear. It can be configured with **Forward(0), Neutral(1), or Backward(2).** However, any value other than 0, 1, or 2 is considered neutral.                         |
